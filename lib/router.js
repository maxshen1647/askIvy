...
// if no existing profile, then render the create profile template when the user clicks the profile link
Router.plugin('dataNotFound', {
  notFoundTemplate: 'profileInsert', 
  only: ['profile']
});
...
Router.onBeforeAction('dataNotFound', {except: ['profile']});
